...
if($mode=="modify") {
?>
	<form name="bf_write" method="post" action="write_insert.php?mode=modify&bf_num=<?=$bf_num?>&page=<?=$page?>&table=<?=$table?>">
<?
} else {
?>
...
?>
		<table>
			...
			<tr>
				<th>제목</th>
				<td><input class="subjecti" type="text" name="subject" value="<?=$bf_title?>"></input></td>
			</tr>
			<tr>
				<th>내용</th>
