<?php
  ...
  if($mode=="deleteAll"){
		...
		$sql="select * from $table where bg_num=".$list[$i];
		...
		$sql="delete from $table where bg_num=".$list[$i];
		mysql_query($sql, $connect);
		$sql="delete from bg_memo where bgm_parent=".$list[$i];
		mysql_query($sql, $connect);
  ...
  mysql_query($sql, $connect);
  $sql="delete from bg_memo where bgm_parent=$num";
  mysql_query($sql, $connect);
